...
for image_name in image_files:
    ...
    cv2.imshow('MTCNN Face Detector: {}'.format(image_name), image)  # display the resultant image
    ...
    cv2.destroyWindow('MTCNN Face Detector: {}'.format(image_name))  # destroy the current image window
