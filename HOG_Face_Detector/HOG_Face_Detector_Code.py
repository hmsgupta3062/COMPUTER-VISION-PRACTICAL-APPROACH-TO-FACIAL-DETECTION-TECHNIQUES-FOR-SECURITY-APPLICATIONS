...
for image_name in image_files:
    ...
    cv2.imshow('HOG Face Detector: {}'.format(image_name), image)  # display the resultant image
    ...
    cv2.destroyWindow('HOG Face Detector: {}'.format(image_name))  # destroy the current image window
