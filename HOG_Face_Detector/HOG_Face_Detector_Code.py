...
for image_name in image_files:
    ...
    cv2.imshow('dlib HOG Classifier: {}'.format(image_name), image)  # display the resultant image
    ...
    cv2.destroyWindow('dlib HOG Classifier: {}'.format(image_name))  # destroy the current image window
